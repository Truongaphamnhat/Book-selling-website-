...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 16, 2023 lúc 04:43 PM
...
(43, 10, 'nhanvien', 'Bạc Liêu', '0971289436', 'truongnv@gmail.com', 0, '2023-11-16 20:21:22', 98000, 0, NULL, NULL, NULL);
...
CREATE TABLE `binhluan` (
  ...
  `nameuser` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `idpro` int(10) NOT NULL,
  `ngaybinhluan` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT current_timestamp()
...
(0, 10, 18, 'nhan_hinh_quan.jpg', 'Nhân Hình Quán', 98000, 1, 98000, 42),
(0, 10, 18, 'nhan_hinh_quan.jpg', 'Nhân Hình Quán', 98000, 1, 98000, 43);
...
CREATE TABLE `taikhoan` (
  ...
  `tel` varchar(12) CHARACTER SET utf8mb4 DEFAULT NULL,
